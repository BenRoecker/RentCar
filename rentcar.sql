...
Boite_a_vitesse VARCHAR(11) NOT NULL, -- Automatique ou Manuelle
Climatisation VARCHAR(13) NOT NULL, -- Climatisé ou Non climatisé
Type_Carburant VARCHAR(20) NOT NULL,
Categorie VARCHAR(10) NOT NULL, -- Economique, confort ou Luxe
No_Client NUMERIC(10) NOT NULL,
Date_Souscription DATE, 
...
Categorie_Employe VARCHAR(9) NOT NULL, -- Agenceur ou Chauffeur
...
Latitude DOUBLE(8,6), -- coordonnées GPS
Longitude DOUBLE(8,6), -- coordonnées GPS
CONSTRAINT PK_Agence PRIMARY KEY (Identifiant)
) engine = InnoDB;

INSERT INTO Clients (No_Client, Nom_Client, Prenom_Client, Email_Client, Rue_Client, Ville_Client, Code_Postal_Client, Numero_Telephone_Client)
VALUES (5571, 'PICHON', 'Gérard', 'gerard.pichon@yahoo.fr', 'Avenue Jean jaurès','Paris',75004,'0145454545');
INSERT INTO Clients (No_Client, Nom_Client, Prenom_Client, Email_Client, Rue_Client, Ville_Client, Code_Postal_Client, Numero_Telephone_Client)
VALUES (420, 'DOGG', 'Snoop', 'snoop.dogg@wanadoo.com', 'Rue de La Fumée','Condrieu',69420,'0420420420');
